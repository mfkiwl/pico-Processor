...
vlog -vlog01compat -work work +incdir+. {picoProcessorBL_7_1200mv_100c_slow.vo}
...
vsim -t 1ps +transport_int_delays +transport_path_delays -L altera_ver -L cycloneive_ver -L gate_work -L work -voptargs="+acc"  tb_pico_processorBL
